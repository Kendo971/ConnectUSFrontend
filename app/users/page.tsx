          ...
          <form action={createUser} className="mt-4 grid grid-cols-1 gap-3">
            <label className="grid gap-1 text-sm text-zinc-700 dark:text-zinc-300">
              ...
              <input
                ...
                defaultValue="1"
                className="h-10 rounded-md border border-zinc-200 px-3 dark:border-zinc-800 dark:bg-black"
              />
            </label>
            ...
            <button
              type="submit"
              className="mt-2 h-11 rounded-md bg-black px-4 text-sm font-medium text-white hover:bg-zinc-800 dark:bg-white dark:text-black dark:hover:bg-zinc-200"
            >
              Créer
            </button>
          </form>
